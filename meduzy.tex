...
Pokud $\phi_q(2) \neq 1$, tak se každý \textit{afinní} prvek zobrazí opět na afinní prvek, tedy body, jejich některá složka je $0$, tvoří vlastí komponentu. Ať je naopak pro nějaká $(a_0,b_0)$ a $n$ nezáporné $\frac{1}{a_{n+1}} + \frac{1}{b_{n+1}} = 0$, pak i $a_{n+1} + b_{n+1} = 0$. Muselo pak být:
\begin{align*}
