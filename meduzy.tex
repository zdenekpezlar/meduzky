...
\begin{align*}
I(\sqrt{2},1) \cdot \frac{2}{\pi} &= \int_{0}^{\pi/2} \frac{d \theta}{\sqrt{ 2 \cos ^2 \theta + 1 \sin ^2 \theta}} \cdot \frac{2}{\pi}\\
...
Vzhledem k tomu, že $AG(a,a) \cdot HG(a,a) = a \cdot a$, vypadá to, že by mohl platit vztah $AG(a,b) \cdot HG(a,b) = ab$. To opravdu platí - všimněme si totiž, že můžeme psát:
